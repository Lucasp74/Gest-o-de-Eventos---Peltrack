    ...
    <div className="min-h-screen bg-fundo">
      ...
      <div className="lg:pl-64 pt-14 lg:pt-0">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div>
            <h1 className="text-2xl font-bold text-grafite">App Desktop</h1>
            <p className="text-grafite-muted text-sm mt-1">
              Leitura de QR Code no computador, mesmo sem internet.
            </p>
          </div>

          <div className="mt-6 bg-white rounded-2xl border border-dashed border-gray-200 py-20 px-6 flex flex-col items-center text-center">
            ...
            <h3 className="text-grafite font-semibold text-base mb-1">Em breve</h3>
            <p className="text-grafite-muted text-sm max-w-sm">
