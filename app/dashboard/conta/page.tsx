      ...
      <div className="lg:pl-64 pt-14 lg:pt-0">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">Gerencie seus dados de acesso.</p>
          </div>
          ...
          <div className="bg-card rounded-2xl border border-border p-5 sm:p-6">
            ...
            <div className="mt-4 pt-4 border-t border-border flex items-center gap-2 text-sm">
              ...
              {hasPassword && (
                <span className="text-xs font-medium bg-fundo border border-border px-2.5 py-1 rounded-full text-foreground">E-mail e senha</span>
              )}
            </div>
          </div>
