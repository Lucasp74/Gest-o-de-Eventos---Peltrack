  ...
  if (!hasData) {
    return (
      <div className="bg-card rounded-2xl border border-dashed border-border py-20 flex flex-col items-center text-center">
        ...
        <h3 className="text-foreground font-semibold text-base mb-1">Sem dados para relatório ainda</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Análise de confirmações e presença do evento</p>
        </div>
        ...
        <div className="relative">
          <button
            ...
            disabled={pdfBusy}
            className="flex items-center gap-1.5 border border-border hover:border-border disabled:opacity-60 text-foreground px-3.5 py-2 rounded-xl text-sm font-medium transition-colors"
          >
            {pdfBusy ? <Loader2 className="w-4 h-4 animate-spin" /> : <Download className="w-4 h-4" />}
            Exportar
            <ChevronDown className={`w-3.5 h-3.5 text-muted-foreground transition-transform ${exportOpen ? "rotate-180" : ""}`} />
          </button>
          ...
          {exportOpen && (
            <>
              ...
              <div className="absolute right-0 top-full mt-1.5 z-40 w-56 bg-card rounded-xl border border-border shadow-xl shadow-black/5 overflow-hidden py-1">
                <button
                ...
                >
                  ...
                  <span>
                    <span className="block text-sm font-medium text-foreground">Excel (CSV)</span>
                    <span className="block text-xs text-muted-foreground">Dados tabulados para planilha</span>
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  <span>
                    <span className="block text-sm font-medium text-foreground">PDF com gráficos</span>
                    <span className="block text-xs text-muted-foreground">Relatório visual pronto para compartilhar</span>
                  </span>
                </button>
              </div>
            </>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2 border-t border-border">
                  ...
                  <p className="text-muted-foreground text-xs">de comparecimento</p>
                </div>
              </div>
            </div>
          )}
